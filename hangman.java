...
class Game {
    ...
    public void startGame() {
        ...
        System.out.println(players[0].getName() + ", enter a word or phrase to start the game:");
        ...
        while (!solved) {
            ...
            System.out.println("Current phrase: " + phrase.getDisplay());
            System.out.println("Points: " + currentPlayer.getScore());

            System.out.print("Guess a letter or type 'solve' to solve: ");
